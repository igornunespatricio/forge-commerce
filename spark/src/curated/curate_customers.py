...
def setup_spark_session(app_name: str = "CustomerSCD2Curator") -> SparkSession:
    """
...
def curate_customers_scd2(
    ...
    if spark is None:
        spark = setup_spark_session("CustomerSCD2Curator")
...
def main():
    ...
    try:
        ...
        curate_customers_scd2(cleaned_path=CLEANED_PATH, curated_path=CURATED_PATH)
        print("Customer curation completed successfully!")
